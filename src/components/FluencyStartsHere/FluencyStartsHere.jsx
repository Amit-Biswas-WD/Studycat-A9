  ...
  return (
    <div className="my-16">
      ...
      <div className="bg-[#499DEC] text-white">
        <h2 className="md:text-4xl sm:text-2xl max-w-[385px] mx-auto text-center -top-4 font-bold ">
        ...
        <p className="text-lg font-normal max-w-[771px] mx-auto text-center py-4">
        ...
        <div className="grid lg:grid-cols-6 md:grid-cols-3 sm:grid-cols-2 grid-cols-2 max-w-screen-xl mx-auto items-center">
